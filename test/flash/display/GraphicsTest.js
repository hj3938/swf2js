...
describe("Graphics.js beginFill test", function()
{
    ...
    it("beginFill test case1", function ()
    {
        ...
        expect(g._$fills.length).toBe(3);
    ...
    it("beginFill test valid case2", function ()
    {
        ...
        // check
        expect(g._$fillStyles.length).toBe(0);
        expect(g._$fills.length).toBe(6);
...
//
//         expect(g._$fills[2][0]).toBe(Graphics.MOVE_TO);
//         expect(g._$fills[2][1]).toBe(700);
//         expect(g._$fills[2][2]).toBe(200);
//
//         expect(g._$fills[3][0]).toBe(Graphics.LINE_TO);
//         expect(g._$fills[3][1]).toBe(1700);
//         expect(g._$fills[3][2]).toBe(200);
//
//         expect(g._$fills[5][0]).toBe(Graphics.LINE_TO);
//         expect(g._$fills[5][1]).toBe(2200);
//         expect(g._$fills[5][2]).toBe(1700);
//
//         expect(g._$fills[7][0]).toBe(Graphics.LINE_TO);
//         expect(g._$fills[7][1]).toBe(700);
//         expect(g._$fills[7][2]).toBe(2200);
//
//         expect(g._$fills[9][0]).toBe(Graphics.LINE_TO);
//         expect(g._$fills[9][1]).toBe(200);
//         expect(g._$fills[9][2]).toBe(700);
//
//         // restart check
//         expect(g._$command).toBe(null);
//         expect(g._$keys.length).toBe(0);
...
// {
//
//     it("endFill test success", function ()
//     {
//
//         var g = new Graphics();
//
...
//             .endFill();
//
//         expect(g._$fills.length).toBe(16);
